...
import { getUser, registerUser, updateUser, deleteUser, loginUser } from '../controls/UserController'
...
userRouter.post('/register', hashPassword, convertAvatarToBufferFormat, registerUser)
